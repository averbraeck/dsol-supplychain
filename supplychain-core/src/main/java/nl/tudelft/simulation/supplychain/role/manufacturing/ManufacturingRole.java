...
/**
 * The manufacturing role is a role that handles the production of products from parts, based on a Bill of Materials (BOM).
 * Parts are sourced from the Inventory, and ready products are added to the Inventory (Make-to-Stock, MTS) or shipped directly
 * to customers (Make-to-Order, MTO).
 * <p>
 ...
 */
public class ManufacturingRole extends Role<ManufacturingRole>
{
    /** */
