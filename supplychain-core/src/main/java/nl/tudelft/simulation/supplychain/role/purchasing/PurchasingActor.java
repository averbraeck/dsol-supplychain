...
/**
 * PurchasingActor is an interface to indicate that an Actor has a PurchasingRole. Since Purchasing usually involves invoices and payments, the
 * PurchasingActor also implements the FinancingActor.
 * <p>
