 ...
 */
public class ManufacturingServiceResource extends ManufacturingService
{
     ...
     */
    public ManufacturingServiceResource(final WarehousingRole owner, final Product product,
            ...
            final HashMap<Product, Double> availableMaterials)
    {
        ...
        if (ready)
        {
            ...
            try
            {
                getOwner().getSimulator().scheduleEventRel(prodctionDuration, this, "endProduction", args);
            }
            catch (Exception e)
            {
