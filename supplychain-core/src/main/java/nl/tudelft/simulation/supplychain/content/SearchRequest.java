...
/**
 * The SearchRequest is a request to a SearchingActor to provide a list, based on some contraints, of actors who could
...
{
    public SearchRequest(final Actor sender, final SearchingActor receiver, final Demand demand,
    ...
    public SearchRequest(final Actor sender, final SearchingActor receiver, final Demand demand, final int maximumNumber,
    ...
    public SearchRequest(final Actor sender, final SearchingActor receiver, final Demand demand, final Product product)
    {
        this(sender, receiver, sender.getSimulatorTime(), sender.getModel().getUniqueMessageId(), demand.groupingId(), demand,
