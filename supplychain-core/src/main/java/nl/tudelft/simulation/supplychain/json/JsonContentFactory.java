 ...
 */
public final class JsonContentFactory
{
    ...
    private static final Map<SupplyChainModelInterface, JsonContentFactory> INSTANCE_MAP = new LinkedHashMap<>();

    /**
     * Create a JsonMessageFactory with the special type adapters.
     * @param model the model for which to register the type adapters
     */
    public JsonContentFactory(final SupplyChainModelInterface model)
    {
        this.model = model;
    ...
    public static Gson instance(final SupplyChainModelInterface model)
    {
        ...
        {
            JsonContentFactory factory = new JsonContentFactory(model);
