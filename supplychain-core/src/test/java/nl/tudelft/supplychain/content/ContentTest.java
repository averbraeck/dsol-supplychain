...
public class ContentTest
{
    ...
    public void contentTest() throws ActorAlreadyDefinedException
    {
        ...
        TestActor actor1 = new TestActor("TA1", "TestActor1", model, new DirectedPoint2d(10, 10, 0), "Dallas, TX");
        TestActor actor2 = new TestActor("TA2", "TestActor2", model, new DirectedPoint2d(20, 20, 0), "Austin, TX");
