 ...
 */
public class DemoBank extends Bank
{
    /** */
    ...
    public DemoBank(final String id, final String name, final SupplyChainModelInterface model, final Point2d location,
            ...
            throws ActorAlreadyDefinedException, RemoteException, NamingException
    {
        ...
        if (getSimulator() instanceof AnimatorInterface)
        {
            new SingleImageRenderable<>(this, getSimulator(),
                    DemoBank.class.getResource("/nl/tudelft/simulation/supplychain/images/ActorBank.gif"));
        }
    }
