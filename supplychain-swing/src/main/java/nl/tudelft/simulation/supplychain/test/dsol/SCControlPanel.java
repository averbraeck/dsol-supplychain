 ...
 */
public class SCControlPanel<T extends Number & Comparable<T>, S extends DevsRealTimeAnimator<T>>
        extends DevsControlPanel<T, S> implements PropertyChangeListener
{
     ...
     */
    public SCControlPanel(final DsolModel<T, ? extends DevsSimulatorInterface<T>> model, final S simulator)
            throws RemoteException
    {
        ...
        this.runSpeedSliderPanel = new SCRunSpeedSliderPanel(100, 1E6, 5000.0, 3, getSimulator());
     ...
     * @author <a href="https://github.com/averbraeck">Alexander Verbraeck</a>
     */
    public static class TimeDouble extends SCControlPanel<Double, DevsRealTimeAnimator<Double>>
    {
        /** */
        private static final long serialVersionUID = 20201227L;
     ...
     * @author <a href="https://github.com/averbraeck">Alexander Verbraeck</a>
     */
    public static class TimeFloat extends SCControlPanel<Float, DevsRealTimeAnimator<Float>>
    {
        /** */
        private static final long serialVersionUID = 20201227L;
         ...
         * @param simulator DevsRealTimeAnimator&lt;Float&gt;; the simulator. Specified separately, because the model can have
         *            been specified with a superclass of the simulator that the ControlPanel actually needs (e.g., model has
         *            been specified with a DevsAnimator, whereas the panel needs a RealTimeControlAnimator)
         * @throws RemoteException when simulator cannot be accessed for listener attachment
         */
     ...
     * @author <a href="https://github.com/averbraeck">Alexander Verbraeck</a>
     */
    public static class TimeLong extends SCControlPanel<Long, DevsRealTimeAnimator<Long>>
    {
        /** */
        private static final long serialVersionUID = 20201227L;
         ...
         * @param simulator DevsRealTimeAnimator&lt;Long&gt;; the simulator. Specified separately, because the model can have
         *            been specified with a superclass of the simulator that the ControlPanel actually needs (e.g., model has
         *            been specified with a DevsAnimator, whereas the panel needs a RealTimeControlAnimator)
         * @throws RemoteException when simulator cannot be accessed for listener attachment
         */
     ...
     * @author <a href="https://github.com/averbraeck">Alexander Verbraeck</a>
     */
    public static class TimeDoubleUnit extends SCControlPanel<Duration, DevsRealTimeAnimator<Duration>>
    {
        /** */
        private static final long serialVersionUID = 20201227L;
         ...
         * @param simulator DevsRealTimeAnimator&lt;Duration&gt;; the simulator. Specified separately, because the model can
                ...
                final DevsRealTimeAnimator<Duration> simulator) throws RemoteException
        {
            ...
            var cp = new ClockPanel.TimeDoubleUnit(getSimulator())
            {
                ...
                {
                    return "t = " + simulationTime.toString(DurationUnit.HOUR, false, true);
                }
            };
            setClockPanel(cp);
     ...
     * @author <a href="https://github.com/averbraeck">Alexander Verbraeck</a>
     */
    public static class TimeFloatUnit extends SCControlPanel<FloatDuration, DevsRealTimeAnimator<FloatDuration>>
    {
        /** */
        private static final long serialVersionUID = 20201227L;
         ...
         * @param simulator DevsRealTimeAnimator&lt;FloatDuration&gt;; the simulator. Specified separately, because the model
         *            can have been specified with a superclass of the simulator that the ControlPanel actually needs (e.g.,
         *            model has been specified with a DevsAnimator, whereas the panel needs a RealTimeControlAnimator)
         * @throws RemoteException when simulator cannot be accessed for listener attachment
         */
